...
return [
    ...
    'Enter a percentage like `5%` or `10.5%`.' => '「5%」や「10.5%」などのパーセンテージを入力してください。',
    ...
    'Plan Information Entry' => 'プラン情報の入力',
    'Plan' => 'プラン',
    ...
    'Short Number' => '短縮番号',
    'Show Chart?' => 'チャートを表示？',
    'Show Estimate Fields' => '見積もりフィールドを表示',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'CPでコマースを表示するデフォルトのビュー。ユーザーに権限がない場合は、ユーザーがアクセス可能な場所に切り替えます。',
