...
return [
    ...
    '(%) off total discounted price (Deprecated)' => '(%) di sconto sul prezzo scontato (deprecato)',
    '(%) off total discounted price and shipping total (Deprecated)' => '(%) di sconto sul totale del prezzo scontato e sul totale della spedizione (deprecato)',
    ...
    'Plan Information Entry' => 'Immissione di informazioni sul piano',
    'Plan' => 'Piano',
    ...
    'Shipping Estimate' => 'Stima del costo di spedizione',
    ...
    'Show Estimate Fields' => 'Mostra campi di stima',
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the discount should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Specifica una <a href="{url}">condizione Twig</a> che determina se lo sconto deve essere applicato a un determinato ordine. (L\'ordine può essere referenziato tramite una variabile "ordine".)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping rule should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Specifica una <a href="{url}">condizione Twig</a> che determina se le regole di spedizione devono essere applicate a un determinato ordine. (L\'ordine può essere referenziato tramite una variabile "ordine".)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `zipCode` variable.)' => 'Specifica una <a href="{url}">condizione Twig</a> che determina se le aree di spedizione devono includere un determinato CAP/codice postale. (Il CAP/codice postale può essere referenziato tramite una variabile "CAP".)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `zipCode` variable.)' => 'Specifica una <a href="{url}">condizione Twig</a> che determina se la zona fiscale deve includere un determinato CAP/codice postale. (Il CAP/codice postale può essere referenziato tramite una variabile "CAP".)',
    ...
    'Tax Estimate' => 'Stima delle imposte',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fallback to a location they can access.' => 'La vista predefinita che viene mostrata quando si visualizza Commerce nel CP. Se l\'utente non dispone dell\'autorizzazione necessaria, verrà riportato in una pagina a cui può accedere.',
