...
return [
    ...
    '(%) off total discounted price (Deprecated)' => '(%) sur le prix réduit (obsolète)',
    '(%) off total discounted price and shipping total (Deprecated)' => '(%) de réduction sur le prix réduit et le total de la livraison (obsolète)',
    '(%) off total original price (Deprecated)' => '(%) sur le prix original (obsolète)',
    ...
    'Show Estimate Fields' => 'Afficher les champs estimés',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'La vue par défaut qui s\'affiche lors de la visualisation de Commerce dans le PC. Si l\'utilisateur n\'a pas de permission, il se rabattra sur un endroit auquel il peut accéder.',
