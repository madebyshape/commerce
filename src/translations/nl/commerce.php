...
return [
    ...
    'Plan Information Entry' => 'Invoer abonnementgegevens',
    'Plan' => 'Plan',
    ...
    'Shipping Estimate' => 'Schatting verzendkosten',
    ...
    'Show Estimate Fields' => 'Schattingsvelden tonen',
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the discount should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Geef een <a href="{url}">Twig-voorwaarde</a> op die bepaalt of de korting van toepassing is voor een specifieke bestelling. (Via een `bestellingsvariabele` kan worden verwezen naar de bestelling.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping rule should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Geef een <a href="{url}">Twig-voorwaarde</a> op die bepaalt of de verzendingsregel van toepassing is voor een specifieke bestelling. (Via een `bestellingsvariabele` kan worden verwezen naar de bestelling.)',
    ...
    'Tax Estimate' => 'Schatting belastingen',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'De standaardweergave voor Commerce in het CS. Als de gebruiker geen rechten heeft, wordt een voor de gebruiker toegankelijke locatie gebruikt.',
