...
return [
    ...
    'Enter a percentage like `5%` or `10.5%`.' => 'Insira uma percentagem como `5%` ou `10.5%`.',
    ...
    'Plan Information Entry' => 'Entrada de informação sobre o plano',
    'Plan' => 'Plano',
    ...
    'Shipping Estimate' => 'Estimativa do envio',
    ...
    'Show Estimate Fields' => 'Mostrar campos estimados',
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the discount should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Especifique uma <a href="{url}">condição Twig</a> que determina se o desconto deve ser aplicado a um pedido específico. (O pedido pode ser referenciado através de uma variável \'pedido\'.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping rule should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Especifique uma <a href="{url}">condição Twig</a> que determina se a regra de envio deve ser aplicada a um pedido específico. (O pedido pode ser referenciado através de uma variável \'pedido\'.)',
    ...
    'Tax Estimate' => 'Estimativa de taxas',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'A vista padrão que é mostrada ao exibir o Commerce no CP. Se o utilizador não tiver permissão, voltará para um local a que pode aceder.',
