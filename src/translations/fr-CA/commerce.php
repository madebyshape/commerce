...
return [
    ...
    '(%) off total discounted price (Deprecated)' => '(%) de rabais sur le prix réduit (obsolète)',
    '(%) off total discounted price and shipping total (Deprecated)' => '(%) de rabais sur le prix réduit et le total de la livraison (obsolète)',
    '(%) off total original price (Deprecated)' => '(%) de rabais sur le prix original total (obsolète)',
    '(%) off total original price and shipping total (Deprecated)' => '(%) de rabais sur le prix original et le total de la livraison (obsolète)',
    ...
    'Plan Information Entry' => 'Entrée des informations sur l\'abonnement',
    'Plan' => 'Projet',
    ...
    'Show Estimate Fields' => 'Afficher les champs d\'estimation',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'La vue par défaut qui s\'affiche lors de la visualisation de Commerce dans le panneau de configuration. Si l\'utilisateur n\'a pas de permission, il sera renvoyé vers un emplacement auquel il peut accéder.',
