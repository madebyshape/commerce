...
return [
    ...
    'Plan Information Entry' => 'Oppføring for planinformasjon',
    'Plan' => 'Plan',
    ...
    'Shipping Estimate' => 'Estimert frakt',
    ...
    'Show Estimate Fields' => 'Vis felter for estimat',
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the discount should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Spesifiser en <a href="{url}">Twig-tilstand</a> som bestemmer om rabatten skal anvendes på en gitt ordre. (Ordren kan henvises til via en ordre-variabel.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping rule should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Spesifiser en <a href="{url}">Twig-tilstand</a> som bestemmer om fraktregelen skal anvendes på en gitt ordre. (Ordren kan henvises til via en ordre-variabel.)',
    ...
    'Default Commerce control panel view. If the user does not have permission it will fall back to a location they can access.' => 'Standardvisning brukes i visning av Commerce i KP. Hvis brukeren ikke har tilgang, vil de sendes tilbake til en område de har tilgang til.',
